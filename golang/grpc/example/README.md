This example generate a client/server API starting from the _protos/server.proto_ file. This file defines a set of rpc operations that depend from the Gingersnap Cloud API entities.
